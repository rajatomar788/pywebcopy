...
class Parser(object):
    ...
    def ensure_parse_is_completed(self):
    ...
    def ensure_root_is_generated(self):
        if self.root is None or not hasattr(self.root, 'getroottree'):
            raise ParseError("Tree is not generated by parser!")
